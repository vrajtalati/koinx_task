...
const GetStarted = () => {
  return (
    <div style={{background:"#0052FE", color:"white"}} className=' p-7 rounded-xl grid grid-row-3 gap-4 place-items-center'>
...
KoinX allows you to be more educated and aware of your tax reports.</div>
    ...
    <div className=' w-100 '>
    <button style={{color:"BLACK"}} className='bg-white font-semibold rounded-xl pr-4 pl-4 pt-2 pb-2'>Get Started for FREE -> </button>
    </div>
    </div>
  )
}
